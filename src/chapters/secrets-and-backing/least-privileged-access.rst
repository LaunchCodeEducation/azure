.. Pat dumped this from an AZ CLI section into what was originally secrets-and-backing or application-environments or something, it doesn't really fit and is well written so I'm moving it to its own file for use later.
